...
module.exports = {
    ...
    create(req, res, next) {
        ...
        let { firstName, lastName, email, phone, gender, birthDate, username, password } = req.body;
    ...
    createForTest(req, res) {
        let { username, password, firstName, lastName, email, phone, gender, birthDate } = req.body;
